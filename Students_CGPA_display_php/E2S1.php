...
<div class="container">
    <div style="color:white;border-radius:20px;" class="custom-card custom-container shadow m-3">
        <div class="card-body">
            <h2 align="center">R19 E2S1 Results</h2>
            ...
            if (isset($_POST['registration_id'])) {
                ...
                $sql = "SELECT * FROM `e2s1_results` WHERE `Reg.Id` = '$specific_reg_id'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='12'>No records found for the given Reg.Id.</td></tr>";
                }
            }
            ?>
        </tbody>
    ...
    <div class="form-group row">
        ...
        ?>
            ...
            <br>
            <a href="E2S2.php" style="font-size: 18px;"><b>For <strong style="font-size: 20px; color: white">E2S2</strong> Results Click here!</b></a><br>
