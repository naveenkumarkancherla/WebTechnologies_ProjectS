...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   if(empty($username_err)){
        ...
        $query = "CREATE TABLE sample (username VARCHAR(20) NOT NULL, password CHAR(15) NOT NULL,mailid VARCHAR(20),phone BIGINT);";
    ...
    if(mysqli_stmt_prepare($initialize, $query))
    {
       ...
       //echo $phone;
       //$k= mysqli_stmt_bind_param($initialize,'i',$phone);
       //echo $k;
