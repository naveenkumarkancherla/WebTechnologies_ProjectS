...
<body>
    ...
    <section id="header">
        <a href="#"><img src="https://www.onlinelogomaker.com/blog/wp-content/uploads/2017/09/fashion-logo-design.jpg" class="fashion" id ="icon" height=120px width=120px alt=""></a>
        <div>
            <ul id="navbar">
...
$(document).ready(function(){
    ...
    <footer class="section-p1">
        <div class="col">
            ...
            <h4>Contact</h4>
            <p><strong>Address:</strong>736 Bloomington,MN,USA</p>
            <p><strong>Phone:</strong>+1 952-883-8800 / (+91) 01 2345 6789</p>
