...
$(document).ready(function(){
    ...
    <div class="carousel slide" id="slider" data-bs-ride="carousel">
        ...
        <img src="https://media.istockphoto.com/photos/mens-accessories-organized-on-table-in-knolling-arrangement-picture-id638385938?k=20&m=638385938&s=612x612&w=0&h=bMFrufzIrYWwRW8ktiKCEOsiem4rsyVcpZJcnmqxGNE=" height="600" width="1500">
        <div class="carousel-caption">
        
        <h5><strong>MENS ACCESSORIES</strong></h5>
        <a href="#feature products" class="btn btn-info" role="button">Shop now</a>
        </div>
        </div>
        <div class="carousel-item">
        <img src="https://media.istockphoto.com/photos/woman-trendy-fashion-accessories-picture-id654407498?k=20&m=654407498&s=612x612&w=0&h=HZPK11dC3KBK6ZGX_Mr7fGFtk7MMn0rxzCTG59LpRtI=" height="600" width="1500">
        </div>
        <div class="carousel-item">
        <img src="https://static.fibre2fashion.com//articleresources/images/5/439/current-fashion-trends-in-costume-jewelry-and-accessories.jpg" height="600" width="1500">
        </div>
        </div>
    ...
    <section id="product1" class="section-p1">
        <h2 id="feature products">Featured Products</h2>
    ...
    <footer class="section-p1">
        ...
        <div class="col install">
            ...
            <div class="row">
                <img src="img/appleicon.png" height=50px width=50px alt="">
                <img src="img/googlestore.png" height=50px width=50px alt="">
            </div> 
